...
namespace curl {
    ...
    public:
        ...
        ~CurlHttpPost();
        template<typename T> CurlHttpPost &add(const CurlPair<CURLformoption,T> &, const CurlPair<CURLformoption,T> &);
    ...
    template<typename T> CurlHttpPost &CurlHttpPost::add(const CurlPair<CURLformoption,T> &pair, const CurlPair<CURLformoption,T> &pair_2) {
